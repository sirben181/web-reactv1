            ...
            <div className="blog_page1 blog_content">
             ...
             •	What other options do I have? Any other</p>
              ...
              <div className="post_footer">
                  <div className="time_written">
                            <div className="date_updated">
                            <p>Last update:<span>17 Oct 2021</span></p>
                        </div>
                        <div className="author">
                            <p>Author:<span>Benson Kamau</span></p>
                        </div>
                    </div>
                    ...
                    <div className="post_feedback">
                        <div className="post_like">
                            <p>like {likes}</p>
                            <span><FcIcons.FcLike onClick={handleLikes}/></span>

                        </div>
                        <div className="post_comment">
                            <p>comment</p>
                            <span><BiIcons.BiCommentDetail /></span>
                        </div>
                    </div>
             </div>
